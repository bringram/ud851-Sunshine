...
//  COMPLETE (20) Create a constant int to identify our loader used in DetailActivity
    private static final int ID_DETAIL_LOADER = 32;
...
//      COMPLETE (13) Find each of the TextViews by ID
        ...
        mHighDisplay = (TextView) findViewById(R.id.high_temperature);
        mLowDisplay = (TextView) findViewById(R.id.low_temperature);
...
//      COMPLETE (26) Display a readable data string
        long weatherDate = data.getLong(INDEX_WEATHER_DATE);
        String dateText = SunshineDateUtils.getFriendlyDateString(this, weatherDate, true);
...
//      COMPLETE (28) Display the high temperature
        ...
        mHighDisplay.setText(highString);
